...
public class Checker {
    public void check(Inf data) {
        $(".modal-body").shouldHave(text((data.fname+" "+data.lname)));
        $(".modal-body").shouldHave(text((data.email)));
        $(".modal-body").shouldHave(text((data.gender)));
        $(".modal-body").shouldHave(text((data.phone)));
        ...
        $(".modal-body").shouldHave(text((data.pict)));
        $(".modal-body").shouldHave(text((data.address)));
        $(".modal-body").shouldHave(text((data.state+" "+data.city)));
    }
}
